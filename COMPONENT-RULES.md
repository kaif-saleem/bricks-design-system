...
- Disabled uses the DS-wide muted-state convention (40% opacity, no pointer events) — the same treatment as Toggle's ReadOnly and every other atom's non-interactive state.

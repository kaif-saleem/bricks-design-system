...
| Accordion | do-not-use | Accordion | Device x Expansion | 4 | none (node 2436:4225, Web+Mobile, plus Show Icon and Show Divider booleans, filled with surface/white, fully token-bound and pipeline-audited per Rulebook §11; chevron icon is a placeholder Lucide vector pending the real Iconography instance swap, see Component-Rules; awaiting review) |
